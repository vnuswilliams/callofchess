...
import { chooseBeginnerMove, describeGameResult, type GameResult } from "@/lib/beginnerComputer";
...
export default function ComputerLesson({ lesson }: { lesson: LessonDefinition }) {
  ...
  const handlePieceDrop = (sourceSquare: string, targetSquare: string | null) => {
    ...
    try {
      ...
      const move = nextGame.move({ from: sourceSquare as Square, to: targetSquare as Square, promotion: "q" });
