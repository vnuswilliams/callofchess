...
export default function Profile() {
  ...
  async function shareProfile() {
    ...
    const shareData = { title: fr ? "Mon niveau Call of Chess" : "My Call of Chess level", text: fr ? `Je progresse aux échecs avec Call of Chess : ${stats.completionRate}% de mon parcours est validé.` : `I’m improving my chess with Call of Chess: ${stats.completionRate}% of my path is complete.`, url: shareUrl };
    try {
