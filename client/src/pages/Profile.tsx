...
export default function Profile() {
  ...
  async function copyProfileLink() {
    try { await navigator.clipboard.writeText(`${window.location.origin}/profile`); setShareState("copied"); } catch { setShareState("error"); }
  }
