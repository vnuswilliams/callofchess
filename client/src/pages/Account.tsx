...
export default function Account() {
  ...
  async function passkeyLogin() {
    ...
    try { const { error } = await supabase.auth.signInWithPasskey(); if (error) throw error; setMessage(fr ? "Connexion Passkey réussie." : "Passkey sign-in succeeded."); setLocation("/profile"); }
