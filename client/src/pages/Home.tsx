    ...
    <div className="echequier-site min-h-screen overflow-hidden bg-[#fbf6e9] text-[#27241d]">
      <header className="echequier-header paper-texture relative z-30 border-b border-[#cbc09f]">
        <div className="mx-auto flex min-h-[76px] max-w-[1440px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <div className="hidden items-center gap-3 lg:flex"><LanguageToggle /><ThemeToggle /><a href="/account" className="text-[.65rem] font-extrabold uppercase tracking-[.12em] text-[#173e37] hover:text-[#8b6217]">{t("account")}</a><Link href="/lesson/1" className="button-ink !min-h-10 !px-5">{t("tryFirstMove")} <ArrowUpRight size={15} /></Link></div>
