...
Le 21 août 2026, `https://callofchess.online/path?deploy_check=160e2b0` se charge sans erreur et affiche la roadmap publique avec le niveau 0 accessible et ses six actions `JOUER`. Cette session de navigateur n’était pas connectée ; elle confirme le bundle et le rendu public, mais ne remplace pas une vérification avec le compte de l’utilisateur pour l’état personnalisé de déblocage.
