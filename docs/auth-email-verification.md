...
- La **Site URL** a été remplacée par `https://callofchess.vercel.app` et Supabase a confirmé : « Successfully updated site URL ».
- Une URL de redirection autorisée `https://callofchess.vercel.app` a été ajoutée et enregistrée.
